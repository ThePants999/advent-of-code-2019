...
## Current status
I've completed the Advent of Code, but only days 1 through 16 plus 18 are currently in a state where they're worth looking at (and 18 takes nearly three minutes to execute, so you probably don't want to look at that one 😆). I'm continuing to work on fixing up the other days.
